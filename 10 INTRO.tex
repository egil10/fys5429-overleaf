...
\textcite{abdelmessih2026visualoptions}.

\[
S\frac{\partial V}{\partial S} + \frac{\partial V}{\partial t} + \frac{1}{2} \sigma^2 S^2\frac{\partial^2V}{\partial S^2} = V
\]

\[
\frac{\partial V}{\partial t} + \frac{1}{2} \sigma^2 S^2\frac{\partial^2V}{\partial S^2} = rV - rS\frac{\partial V}{\partial S}
\]
...
\item $N(\cdot)$ = standard normal CDF
\item $\phi(\cdot)$ = standard normal PDF
\end{itemize}
...
\begin{align}
    ...
    \\
    \text{Vanna} &= \frac{\partial^2 V}{\left( \partial S \partial \sigma  \right)}
    & \hfill 
    \text{Charm} &= \frac{\partial^2 V}{\left( \partial S \partial t \right)}
    \\
    \text{Speed} &= \frac{\partial^3 V}{\partial S^3} 
    & \hfill 
    \text{Zomma} &= \frac{\partial^3 V}{\left( \partial S^2 \partial \sigma \right)}
    \\
    \Phi &= \frac{\partial V}{\partial q} 
    & \hfill 
    \text{Color} &= \frac{\partial^3 V}{(\partialS^2\partial t)}
\end{align}

\section*{Black--Scholes Equation in Greek Form}
