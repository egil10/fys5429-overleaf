...
\begin{figure*}[t]
    ...
    \caption{Final Heston PINN solution after $50\,000$ training epochs, evaluated on the fixed-variance slice $v=v_0=0.04$ and compared with the semi-analytical Heston reference solution. The PINN captures the main structure of the Heston call-price surface, including the low-value out-of-the-money region and the increasing in-the-money region. Since the full learned function depends on $(S,v,\tau)$, this figure shows only a two-dimensional slice of the three-dimensional pricing function.}
